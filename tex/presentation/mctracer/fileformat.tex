...
\begin{frame}{Graphischer Überblick}
	\puta(-60,-150){
		\noindent \includegraphics[height=\textheight]{\string"mctracer/dateiaufbau1\string".png}
	}
\end{frame}

\begin{frame}{Graphischer Überblick}
	\puta(-60,-150){
		\noindent \includegraphics[height=\textheight]{\string"mctracer/dateiaufbau2\string".png}
	}
\end{frame}

\begin{frame}{Graphischer Überblick}
	\puta(-60,-150){
		\noindent \includegraphics[height=\textheight]{\string"mctracer/dateiaufbau3\string".png}
	}
\end{frame}