...
\includegraphics[height=0.85\textheight]{mctracer/dateiaufbau1}
\end{frame}

\begin{frame}{Graphischer Überblick}
 \includegraphics[height=0.85\textheight]{mctracer/dateiaufbau2}
\end{frame}

\begin{frame}{Graphischer Überblick}
 \includegraphics[height=0.85\textheight]{mctracer/dateiaufbau3}
\end{frame}