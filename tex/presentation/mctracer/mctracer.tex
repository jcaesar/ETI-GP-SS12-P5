...
\subsection{Valgrind} \input{mctracer/valgrind.tex}
...
\subsection{Eventverarbeitungsstruktur} \input{mctracer/structure.tex}
\subsection{Dateiformat} \input{mctracer/fileformat.tex}