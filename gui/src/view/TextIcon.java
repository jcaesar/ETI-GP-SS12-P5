 ...
 *
 * TextIcon supports two different layout styles: <ul> <li>Horizontally - does
 * normal rendering of the text by using the Graphics.drawString(...) method
 * <li>Vertically - Each character is displayed on a separate line </ul>
 *
